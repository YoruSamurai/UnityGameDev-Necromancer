...
public class 骨爪 : MeleeEquipment
{
    ...
    public override void TriggerHitCheckStart()
    {
        ...
        ZoneEvaluator zoneDetector = new ZoneEvaluator();
        List<Vector2Int> zonePosList = zoneDetector.GetGenerateZonePosList(transform.position, 6, 1, player.GetFacingRight(), true);
        ProjectileManager.Instance.GenerateZone(zonePosList, 5f, 0.05f, 0.5f, false, this);
